...
export namespace Prisma {
  ...
  */
  ...
  export type GetServerInformationAggregateType<T extends ServerInformationAggregateArgs> = {
        [P in keyof T & keyof AggregateServerInformation]: P extends '_count' | 'count'
      ? T[P] extends true
        ? number
  ...
  type GetServerInformationGroupByPayload<T extends ServerInformationGroupByArgs> = PrismaPromise<
    Array<
      PickArray<ServerInformationGroupByOutputType, T['by']> &
        {
          [P in ((keyof T) & (keyof ServerInformationGroupByOutputType))]: P extends '_count'
            ? T[P] extends boolean
              ? number
  ...
  export type ServerInformationGetPayload<S extends boolean | null | undefined | ServerInformationArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? ServerInformation :
    S extends undefined ? never :
    S extends { include: any } & (ServerInformationArgs | ServerInformationFindManyArgs)
    ? ServerInformation 
    : S extends { select: any } & (ServerInformationArgs | ServerInformationFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
    P extends keyof ServerInformation ? ServerInformation[P] : never
  } 
      : ServerInformation
  ...
  export interface ServerInformationDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    /**
     ...
     * })
    **/
    findUnique<T extends ServerInformationFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, ServerInformationFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'ServerInformation'> extends True ? Prisma__ServerInformationClient<ServerInformationGetPayload<T>> : Prisma__ServerInformationClient<ServerInformationGetPayload<T> | null, null>
    ...
    **/
     ...
     * })
    **/
    findFirst<T extends ServerInformationFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, ServerInformationFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'ServerInformation'> extends True ? Prisma__ServerInformationClient<ServerInformationGetPayload<T>> : Prisma__ServerInformationClient<ServerInformationGetPayload<T> | null, null>
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends ServerInformationAggregateArgs>(args: Subset<T, ServerInformationAggregateArgs>): PrismaPromise<GetServerInformationAggregateType<T>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, ServerInformationGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetServerInformationGroupByPayload<T> : PrismaPromise<InputErrors>
   ...
   */
  export class Prisma__ServerInformationClient<T, Null = never> implements PrismaPromise<T> {
    [prisma]: true;
   ...
   */
  export interface ServerInformationFindUniqueArgs extends ServerInformationFindUniqueArgsBase {
   /**
   ...
   */
  export interface ServerInformationFindFirstArgs extends ServerInformationFindFirstArgsBase {
   /**
    * Throw an Error if query returns no results
  ...
  export type ServerInformationCreateArgs = {
    ...
    **/
     ...
     * 
    **/
    data: XOR<ServerInformationCreateInput, ServerInformationUncheckedCreateInput>
  }
  ...
  export type ServerInformationUpdateArgs = {
    ...
    **/
     ...
     * 
    **/
    data: XOR<ServerInformationUpdateInput, ServerInformationUncheckedUpdateInput>
    /**
  ...
  export type ServerInformationUpdateManyArgs = {
     ...
     * 
    **/
    data: XOR<ServerInformationUpdateManyMutationInput, ServerInformationUncheckedUpdateManyInput>
    /**
  ...
  export type ServerInformationUpsertArgs = {
    ...
    **/
     ...
     * 
    **/
    create: XOR<ServerInformationCreateInput, ServerInformationUncheckedCreateInput>
    /**
     * In case the ServerInformation was found with the provided `where` argument, update it with this data.
     * 
    **/
    update: XOR<ServerInformationUpdateInput, ServerInformationUncheckedUpdateInput>
  }
  ...
  export class Prisma__PlayerClient<T, Null = never> implements PrismaPromise<T> {
    ...
    games<T extends Game_PlayerFindManyArgs= {}>(args?: Subset<T, Game_PlayerFindManyArgs>): PrismaPromise<Array<Game_PlayerGetPayload<T>>| Null>;
  ...
  export type AccountGetPayload<S extends boolean | null | undefined | AccountArgs> =
    ...
    : S extends { select: any } & (AccountArgs | AccountFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'player' ? PlayerGetPayload<S['select'][P]> :  P extends keyof Account ? Account[P] : never
  } 
      : Account
  ...
  export type GameGetPayload<S extends boolean | null | undefined | GameArgs> =
    ...
    ? Game  & {
    [P in TruthyKeys<S['include']>]:
        P extends 'players' ? Array < Game_PlayerGetPayload<S['include'][P]>>  :
        P extends '_count' ? GameCountOutputTypeGetPayload<S['include'][P]> :  never
  } 
    : S extends { select: any } & (GameArgs | GameFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'players' ? Array < Game_PlayerGetPayload<S['select'][P]>>  :
  ...
  export class Prisma__GameClient<T, Null = never> implements PrismaPromise<T> {
    ...
    players<T extends Game_PlayerFindManyArgs= {}>(args?: Subset<T, Game_PlayerFindManyArgs>): PrismaPromise<Array<Game_PlayerGetPayload<T>>| Null>;
  ...
  type GetGame_PlayerGroupByPayload<T extends Game_PlayerGroupByArgs> = PrismaPromise<
    Array<
      PickArray<Game_PlayerGroupByOutputType, T['by']> &
        {
          [P in ((keyof T) & (keyof Game_PlayerGroupByOutputType))]: P extends '_count'
            ? T[P] extends boolean
              ? number
  ...
  export type Game_PlayerGetPayload<S extends boolean | null | undefined | Game_PlayerArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    ...
    [P in TruthyKeys<S['select']>]:
        ...
        P extends 'player' ? PlayerGetPayload<S['select'][P]> :  P extends keyof Game_Player ? Game_Player[P] : never
  } 
      : Game_Player
  ...
  export interface Game_PlayerDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    /**
     ...
     * })
    **/
    findUnique<T extends Game_PlayerFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, Game_PlayerFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Game_Player'> extends True ? Prisma__Game_PlayerClient<Game_PlayerGetPayload<T>> : Prisma__Game_PlayerClient<Game_PlayerGetPayload<T> | null, null>
    ...
    **/
     ...
     * })
    **/
    findFirst<T extends Game_PlayerFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, Game_PlayerFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Game_Player'> extends True ? Prisma__Game_PlayerClient<Game_PlayerGetPayload<T>> : Prisma__Game_PlayerClient<Game_PlayerGetPayload<T> | null, null>
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends Game_PlayerAggregateArgs>(args: Subset<T, Game_PlayerAggregateArgs>): PrismaPromise<GetGame_PlayerAggregateType<T>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, Game_PlayerGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetGame_PlayerGroupByPayload<T> : PrismaPromise<InputErrors>
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__Game_PlayerClient<T, Null = never> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
   ...
   */
  export interface Game_PlayerFindUniqueArgs extends Game_PlayerFindUniqueArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
    */
   ...
   */
  export interface Game_PlayerFindFirstArgs extends Game_PlayerFindFirstArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
    */
  ...
  export type Game_PlayerUpdateManyArgs = {
     ...
     * 
    **/
    data: XOR<Game_PlayerUpdateManyMutationInput, Game_PlayerUncheckedUpdateManyInput>
    /**
  ...
  export type Game_PlayerScalarFieldEnum = (typeof Game_PlayerScalarFieldEnum)[keyof typeof Game_PlayerScalarFieldEnum]
  ...
  export type ServerInformationScalarFieldEnum = (typeof ServerInformationScalarFieldEnum)[keyof typeof ServerInformationScalarFieldEnum]
  ...
  export type AccountCreateNestedManyWithoutPlayerInput = {
    create?: XOR<Enumerable<AccountCreateWithoutPlayerInput>, Enumerable<AccountUncheckedCreateWithoutPlayerInput>>
  ...
  export type Game_PlayerCreateNestedManyWithoutPlayerInput = {
    create?: XOR<Enumerable<Game_PlayerCreateWithoutPlayerInput>, Enumerable<Game_PlayerUncheckedCreateWithoutPlayerInput>>
  ...
  export type Game_PlayerCreateNestedManyWithoutGameInput = {
    create?: XOR<Enumerable<Game_PlayerCreateWithoutGameInput>, Enumerable<Game_PlayerUncheckedCreateWithoutGameInput>>
  ...
  export type Game_PlayerCreateOrConnectWithoutPlayerInput = {
    where: Game_PlayerWhereUniqueInput
    create: XOR<Game_PlayerCreateWithoutPlayerInput, Game_PlayerUncheckedCreateWithoutPlayerInput>
  }
  ...
  export type Game_PlayerUpsertWithWhereUniqueWithoutPlayerInput = {
    where: Game_PlayerWhereUniqueInput
    update: XOR<Game_PlayerUpdateWithoutPlayerInput, Game_PlayerUncheckedUpdateWithoutPlayerInput>
    create: XOR<Game_PlayerCreateWithoutPlayerInput, Game_PlayerUncheckedCreateWithoutPlayerInput>
  }

  export type Game_PlayerUpdateWithWhereUniqueWithoutPlayerInput = {
    where: Game_PlayerWhereUniqueInput
    data: XOR<Game_PlayerUpdateWithoutPlayerInput, Game_PlayerUncheckedUpdateWithoutPlayerInput>
  }

  export type Game_PlayerUpdateManyWithWhereWithoutPlayerInput = {
    where: Game_PlayerScalarWhereInput
    data: XOR<Game_PlayerUpdateManyMutationInput, Game_PlayerUncheckedUpdateManyWithoutGamesInput>
  }
  ...
  export type Game_PlayerCreateOrConnectWithoutGameInput = {
    where: Game_PlayerWhereUniqueInput
    create: XOR<Game_PlayerCreateWithoutGameInput, Game_PlayerUncheckedCreateWithoutGameInput>
  }
  ...
  export type Game_PlayerUpsertWithWhereUniqueWithoutGameInput = {
    where: Game_PlayerWhereUniqueInput
    update: XOR<Game_PlayerUpdateWithoutGameInput, Game_PlayerUncheckedUpdateWithoutGameInput>
    create: XOR<Game_PlayerCreateWithoutGameInput, Game_PlayerUncheckedCreateWithoutGameInput>
  }

  export type Game_PlayerUpdateWithWhereUniqueWithoutGameInput = {
    where: Game_PlayerWhereUniqueInput
    data: XOR<Game_PlayerUpdateWithoutGameInput, Game_PlayerUncheckedUpdateWithoutGameInput>
  }

  export type Game_PlayerUpdateManyWithWhereWithoutGameInput = {
    where: Game_PlayerScalarWhereInput
    data: XOR<Game_PlayerUpdateManyMutationInput, Game_PlayerUncheckedUpdateManyWithoutPlayersInput>
  }
